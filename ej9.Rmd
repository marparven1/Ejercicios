...
Estimar el valor de: $$I =\int_{1}^{+ \infty} \int_{3}^{+ \infty} 2x e^{(1-x^2)y^2}    \,dx   \,dy .$$
...
- $x=\dfrac{6}{1-u_1}-3 =   \dfrac{3(u_1-1)}{1-u_1} \quad \implies dx = \dfrac{-2u_1}{(1-u_1)^2}  du_2$
- $y=\dfrac{2}{1-u_2}-1 =   \dfrac{1+u_2}{1-u_2} \quad \implies dx = \dfrac{-2u_2}{(1-u_2)^2}  du_1$ 

La integral queda de la siguiente forma:

${\Big(\dfrac{1+u_2}{1-u_2}\Big) }^2$

$$I_2 = -12 \int_{0}^{1} \int_{0}^{1} 2\dfrac{1+u_1}{1-u_1}  \cdot
e^{  \Bigg( {1-{\Big(\dfrac{1+u_2}{1-u_2}\Big) }^2 } \Bigg)  \cdot  {\Big(\dfrac{1+u_2}{1-u_2}\Big)}^2}    \cdot \dfrac{1}{(1-u_1)^2(1-u_2)^2} \,du_1   \,du_2 . =$$
$$= -24 \int_{0}^{1} \int_{0}^{1} \dfrac{1+u_1}{(1-u_1)^3(1-u_2)^2}  \cdot
e^{   \dfrac{-4u_1}{(1-u_1)^2}  \cdot  {\Big(\dfrac{1+u_2}{1-u_2}\Big)}^2  }     \,du_1   \,du_2 .$$
...
Es decir, \(I_{6} = \mathbb{E}[g(\vec{U})]\), donde \(\vec{U} = \big(U_{1}, U_{2}\big)\) es un vector aleatorio uniforme en \((0, 1) \times (0, 1)\) (equivalentemente, \(U_{1}\) y \(U_{2}\) son variables independientes uniformes en el intervalo \((0, 1)\)) y \(g(u_{1}, u_{2}) = \dfrac{1+u_1}{(1-u_1)^3(1-u_2)^2}  \cdot
e^{   \dfrac{-4u_1}{(1-u_1)^2}  \cdot  {\Big(\dfrac{1+u_2}{1-u_2}\Big)}^2  } \).
...
g <- function(u) {
  ...
  u_1 <- u[1]
  u_2 <- u[2]
  ((1+u_1)/((1-u_1)^3 * (1-u_2)^2))*exp((-4*u_1)/((1-u_1)^2)*((1+u_2)/(1-u_2))^2)
}
```
...
estimacion_directo <-24* mean(valores_g)
varianza_directo <- 24^2*var(valores_g) / n
...
```{r estimacion}
estimacion_antiteticas <- 24*mean(valores)
varianza_antiteticas <- 24^2*(var(valores) / (n / 2))
...
24^2* ( sum(estratos$probabilidad^2 * sapply(valores, var) / n_estratos))
