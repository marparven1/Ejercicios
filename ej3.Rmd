...
Al representar gráficamente la función \(g\), podemos comprobar que es una función ni es creciente ni decreciente, por lo que el método de las variables antitéticas no nos garantiza una reducción de varianza. Se aplica el método igualmente para ver los resultados.
